...
// parents(['선택자']) : 선택된 요소의 모든 상위 요소를 선택하거나, 매개변수가 있으면
// 매개변수와 일치하는 상위 요소만 선택
...
// sapn 요소부터 div 요소 이전까지 상위 요소에 배경색 : lavenderblush
...
// 매개변수가 있으면 같은 레벨의 다음 요소 중 매개변수가 일치하는 요소까지 선택
